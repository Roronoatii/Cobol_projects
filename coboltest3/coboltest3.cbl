      ...
      *> NOT EQUAL TO    
           ...
           END-IF
           IF Age LESS THAN 3 THEN 
               DISPLAY "Stay Home"
           END-IF 
           IF Age GREATER THAN 3 AND LESS THAN 5 THEN
               DISPLAY "Go to Maternelle"
           END-IF
           IF Age = 5 THEN
               DISPLAY "Go to Primaire"
           END-IF
      ...
      *> NUMERIC ALPHABETIC ALPHABETIC-UPPER
           ...
           DISPLAY "Enter Single Number or X to Exit : " WITH NO 
           ADVANCING  
           ACCEPT TestNumber
